### the script for running the 2017 sorting competition 
...
groups = 20 #number of groups (including group 0 which is the sample sorting)
inFileNames = ["prelim1.txt", "prelim2.txt"]
runTimes = []
sortedTimes = []
